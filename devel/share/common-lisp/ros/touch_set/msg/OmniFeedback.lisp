...
(cl:defmethod cl:initialize-instance :after ((m <OmniFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OmniFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name touch_set-msg:<OmniFeedback> is deprecated: use touch_set-msg:OmniFeedback instead.")))

(cl:ensure-generic-function 'force-val :lambda-list '(m))
(cl:defmethod force-val ((m <OmniFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader touch_set-msg:force-val is deprecated.  Use touch_set-msg:force instead.")
  (force m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <OmniFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader touch_set-msg:position-val is deprecated.  Use touch_set-msg:position instead.")
  (position m))
