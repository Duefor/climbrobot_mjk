...
(cl:defmethod cl:initialize-instance :after ((m <OmniButtonEvent>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OmniButtonEvent)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name touch_set-msg:<OmniButtonEvent> is deprecated: use touch_set-msg:OmniButtonEvent instead.")))

(cl:ensure-generic-function 'grey_button-val :lambda-list '(m))
(cl:defmethod grey_button-val ((m <OmniButtonEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader touch_set-msg:grey_button-val is deprecated.  Use touch_set-msg:grey_button instead.")
  (grey_button m))

(cl:ensure-generic-function 'white_button-val :lambda-list '(m))
(cl:defmethod white_button-val ((m <OmniButtonEvent>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader touch_set-msg:white_button-val is deprecated.  Use touch_set-msg:white_button instead.")
  (white_button m))
