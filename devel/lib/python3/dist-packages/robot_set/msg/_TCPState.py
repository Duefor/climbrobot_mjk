...
"""autogenerated by genpy from robot_set/TCPState.msg. Do not edit."""
import codecs
import sys
...
class TCPState(genpy.Message):
  _md5sum = "5fbf541e654dab38ddd37689024b1edc"
  _type = "robot_set/TCPState"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """std_msgs/Header header  # 携带时间戳和参考坐标系ID
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TCPState, self).__init__(*args, **kwds)
